...
//    static Student[] students =null;
    static List<Student2> studentList = new ArrayList<>();
    
    public static void main(String[] args) throws Exception {
        StudentManagement2 std = new StudentManagement2();
    ...
    public void showMenu(){
     ...
     public void inputStudent(Student2 st){
    ...
    public void write(Student2[] students) {  
        try {   
    ...
    public void show(Student2[] students) throws Exception {    
        try {
            for (int i = 0; i < students.length; i++) {
