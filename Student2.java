 ...
 * @author Admin
 */
public class Student2 extends Person2 implements Comparable<Student2>,Serializable{
    ...
    public Student2(int studentId, int academic_year, float gpa, float social_activities, String name, String gender, int birth_year) {
